...
API_ID = int(environ['API_ID', '28430134'])
API_HASH = environ['API_HASH','c3cd07e1c60c6ab046ef34a8d5aa7514']
BOT_TOKEN = environ['BOT_TOKEN', '6181732075:AAEdRy-OmccQPFFf8SfRNfStckH_GUqAFFw']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5992637806').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001963298429').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5992637806').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://LilyAdams:LilyAdams@cluster02.wnrf1uc.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster02")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1001842498325 ))
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL' -1001909681447))

#ai
OPENAI_API = environ.get("OPENAI_API","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")
